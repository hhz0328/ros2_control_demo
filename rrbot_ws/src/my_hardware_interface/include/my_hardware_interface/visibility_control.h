...
#ifndef MY_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define MY_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // MY_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
